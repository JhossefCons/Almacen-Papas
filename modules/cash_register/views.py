...
class CashRegisterView:
    ...
    def setup_ui(self):
        ...
        # Treeview dentro de la pestaña Movimientos (¡único treeview!)
        ...
        self.tree.column('payment', width=90, anchor=tk.CENTER)
    ...
    def edit_transaction(self):
        ...
        # Aquí podrías abrir un diálogo para editar (no implementado)
    ...
    def show_monthly_chart(self):
        ...
        try:
            ...
            try:
                ...
                # Preparar datos (¡usa las claves correctas del controlador!)
